...
def main():
    params = yaml.safe_load(open("params.yaml", encoding="utf-8"))["prepare"]
    ...
    with open(input_path, "r", encoding="utf-8") as fd_in:
        input_lines = fd_in.readlines()

    with open(output_train, "w", encoding="utf-8") as fd_out_train, \
            open(output_test, "w", encoding="utf-8") as fd_out_test:
